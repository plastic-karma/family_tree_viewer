...
- **Editing and export** — update a person's name and birth date, search for existing people to link as siblings, or unlink sibling relationships without deleting people, then download a GED file without dropping unrecognized source data
